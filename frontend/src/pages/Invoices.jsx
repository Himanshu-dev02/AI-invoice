...
import AiReminderModal from "../components/AiReminder";
                  ...
                  <tr key={inv.id} className={invoicesStyles.tableRow}>
                    ...
                    <td className={invoicesStyles.actionsCell}>
                      <div className={invoicesStyles.actionsContainer}>
                        ...
                        {/* AI Reminder mail button — only for unpaid/draft invoices */}
                        {(inv.status || "").toLowerCase() !== "paid" && (
                          <button
                            type="button"
                            title="Send AI-generated payment reminder"
                            onClick={() => setReminderInv(inv)}
                            style={{
                              display: "inline-flex",
                              alignItems: "center",
                              gap: "6px",
